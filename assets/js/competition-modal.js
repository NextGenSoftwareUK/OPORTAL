(function () {
  ...
  function showStatus(type, msg) { var el = getById('competition-status'); if (!el) return; el.className = 'competition-status competition-status--' + type; el.textContent = msg; el.hidden = false; }
