(function () {
  ...
  function showStatus(type, msg) { var el = getById('inventory-status'); if (!el) return; el.className = 'inventory-status inventory-status--' + type; el.textContent = msg; el.hidden = false; }
